...
const CARD_BG = { background: 'linear-gradient(150deg, rgba(247,195,148,0.18) 0%, rgba(242,194,207,0.14) 48%, rgba(228,230,156,0.16) 100%), radial-gradient(ellipse 120% 90% at 50% 0%, #FDFBF7 0%, #F7F4EF 62%)' }
      ...
      <main className="relative z-10 pb-28 md:pb-0">
          ...
          <div
            ...
            style={{
              backgroundImage:
                ...
                'radial-gradient(34% 30% at 86% 84%, rgba(228,230,156, 0.26), transparent 72%), ' +
                'radial-gradient(30% 28% at 6% 88%, rgba(228,230,156, 0.18), transparent 72%), ' +
                'radial-gradient(28% 24% at 60% 6%, rgba(240,228,158, 0.24), transparent 72%)',
            }}
          />
        ...
        <SectionWash mask="linear-gradient(to bottom, transparent 0%, black 25%, black 100%)">
          ...
          <section className="relative w-full px-[5vw] py-[clamp(3rem,7vw,6rem)]">
            <Label gradient={['#B04A76', '#8E63B8']}>{CORPORATE.why.label}</Label>
            <SplitText
              as="h2"
              unit="char"
            ...
            <div className="mt-[clamp(2rem,5vw,3.5rem)] grid grid-cols-1 gap-6 sm:grid-cols-3">
              {CORPORATE.why.cards.map((c, i) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <Drop className="h-5 w-auto" gradient={['#B04A76', '#8E63B8']} />
          ...
          <section className="relative w-full px-[5vw] py-[clamp(2.5rem,6vw,5rem)]">
            <div className="grid grid-cols-12 gap-x-8 gap-y-10">
              <div className="col-span-12 lg:col-span-5">
                <Label gradient={['#8E63B8', '#B04A76']}>{CORPORATE.occasions.label}</Label>
                <SplitText
                  as="h2"
                  unit="char"
              ...
              <div className="col-span-12 lg:col-span-6 lg:col-start-7">
                <ul className="flex flex-col">
                  {CORPORATE.occasions.items.map((item, i) => (
                    ...
                    >
                      <Drop className="h-4 w-auto shrink-0" gradient={['#B04A76', '#8E63B8']} />
        ...
        <div className="relative bg-paper-deep">
          ...
          <SectionWash>
            ...
            <section className="relative w-full px-[5vw] pt-[clamp(3.5rem,7vw,6rem)] pb-[clamp(1rem,3vw,2rem)]">
              <Label gradient={['#B04A76', '#8E63B8']}>{CORPORATE.how.label}</Label>
              <SplitText
                as="h2"
                unit="char"
            ...
            <section className="relative w-full px-[5vw] pt-[clamp(3rem,6vw,5rem)] pb-[clamp(2rem,4vw,3rem)]">
              <Label gradient={['#B04A76', '#8E63B8']}>{CORPORATE.offer.label}</Label>
              <SplitText
                as="h2"
                unit="char"
                    ...
                    <ul className="mt-6 flex flex-col gap-3 border-t border-line/60 pt-6 text-sm text-ink/85">
                      {CORPORATE.offer.base.bullets.map((b) => (
                        <li key={b} className="flex gap-3">
                          <Drop className="mt-0.5 h-4 w-auto shrink-0" gradient={['#B04A76', '#8E63B8']} />
                          {b}
                        </li>
                      ))}
                    </ul>
