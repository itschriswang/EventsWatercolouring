        ...
        >
          <div className="flex items-start gap-3 sm:block">
            ...
            <div className="flex grow items-end justify-center sm:mx-auto sm:w-[92%] lg:mx-0 lg:w-full lg:justify-end">
              ...
              <div className="relative z-0 w-[56%] shrink-0 translate-x-[6%] translate-y-[32%] sm:translate-x-0 sm:w-[52%] sm:translate-y-0 sm:-ml-[8%] lg:-ml-[10%] lg:-translate-y-[11%]">
                <motion.figure
              ...
              {/* Character — raised much higher, in front, overlapping. The
                  ...
                  doesn't clobber it. */}
              <div className="relative z-10 -ml-[12%] w-[58%] shrink-0 -translate-y-[10%] sm:-ml-[14%] sm:w-[54%] sm:-translate-y-[30%] lg:-translate-y-[22%]">
                <motion.figure
