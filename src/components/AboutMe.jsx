      ...
      <div className="relative pb-[clamp(5rem,10vw,8rem)]">
        <div className="grid grid-cols-12 items-start gap-x-8 gap-y-8">
          ...
          <div className="relative col-span-12 sm:col-span-6 sm:col-start-1 lg:col-span-6 lg:col-start-1">
            ...
            <Label gradient={['#FF5A3C', '#E0A81E']}>{PAINTER.label}</Label>
            <SplitText
              as="h2"
              unit="char"
              lines={PAINTER.title}
          ...
          >
            <div className="relative sm:ml-auto sm:max-w-[20rem]">
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(145deg, rgba(201,139,140,0.55) 0%, rgba(255,90,60,0.50) 55%, rgba(224,168,30,0.42) 100%)',
                  filter: 'blur(22px)',
              ...
              >
                <CornerBloom from="rgba(255,90,60,0.15)" to="rgba(228,136,156,0.11)" overlay />
