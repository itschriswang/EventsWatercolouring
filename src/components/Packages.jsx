  ...
  return (
    <section id="offerings" className="relative w-full px-[5vw] py-[clamp(4rem,8vw,7rem)]">
      ...
      <div className="relative mt-[clamp(2rem,8vw,3rem)] lg:hidden">
        ...
        <motion.div
          {...reveal(1)}
          className="relative z-20 -mt-[1vw] ml-6 max-w-[calc(100vw-5vw*2-1.5rem)] overflow-hidden border-2 border-ink bg-paper p-6 shadow-[0_24px_50px_-30px_rgba(42,39,36,0.6)]"
        >
