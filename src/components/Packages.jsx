...
export default function Packages() {
  ...
  return (
    <section id="offerings" className="relative w-full px-[5vw] pt-[clamp(3rem,6vw,5.5rem)] pb-[clamp(5rem,10vw,9rem)]">
      ...
      <Label gradient={['#C98B8C', '#D4A12E']}>{PACKAGES.label}</Label>
      <SplitText
        as="h2"
        unit="char"
      ...
      <div className="relative mt-[clamp(3.5rem,12vw,5rem)] lg:hidden">
        ...
        >
          <CornerBloom from="rgba(201,139,140,0.18)" to="rgba(228,136,156,0.12)" />
            ...
            <ul className="mt-6 flex flex-col gap-3 border-t border-line/60 pt-6 text-sm text-ink/85">
              {PACKAGES.base.bullets.map((b) => (
                <li key={b} className="flex gap-3">
                  <Drop className="mt-0.5 h-4 w-auto shrink-0" gradient={['#C98B8C', '#D4A12E']} />
                  {b}
                </li>
              ))}
            </ul>
                ...
                <motion.li key={a.h} {...reveal(i % 3)} className="border-b border-line">
                  ...
                  >
                    ...
                    <motion.span
                      ...
                      aria-hidden="true"
                    >
                      <Drop className="h-3.5 w-auto" gradient={['#C98B8C', '#D4A12E']} />
                    </motion.span>
                  </button>
      ...
      <div className="mt-[clamp(2.5rem,6vw,4rem)] hidden grid-cols-12 gap-8 lg:grid">
        ...
        <motion.div
          ...
          style={{ background: 'radial-gradient(ellipse 120% 90% at 50% 0%, #FBF8F2 0%, #F4EFE6 62%)' }}
        >
          <CornerBloom from="rgba(212,161,46,0.16)" to="rgba(228,136,156,0.12)" />
      ...
      <motion.a
        ...
        style={{ background: 'radial-gradient(ellipse 120% 90% at 50% 0%, #FBF8F2 0%, #F4EFE6 62%)' }}
      >
        <CornerBloom from="rgba(212,161,46,0.16)" to="rgba(201,139,140,0.14)" />
        <span className="relative z-10 flex items-center gap-4 sm:gap-5">
          <span
            ...
            aria-hidden="true"
          >
            <Drop className="h-5 w-auto" gradient={['#C98B8C', '#D4A12E']} />
          </span>
          <span>
