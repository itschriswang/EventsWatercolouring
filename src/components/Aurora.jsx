...
export default function Aurora(props) {
  const { colorStops = ['#B5395B', '#AEBF56', '#C9A23A'], amplitude = 1.0, blend = 0.5 } = props;
  ...
  return <div ref={ctnDom} className="w-full h-full" style={{ position: 'absolute', inset: 0, pointerEvents: 'none' }} />;
}
