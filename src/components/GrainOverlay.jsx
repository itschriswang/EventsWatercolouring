...
export default function GrainOverlay() {
  ...
  return (
    <div
      aria-hidden="true"
      // zoom-mute: same pinch-zoom guard as GrainCanvas (see index.css).
      className="zoom-mute pointer-events-none fixed inset-0 z-[60] opacity-[0.075] mix-blend-multiply"
    >
